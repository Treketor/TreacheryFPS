...
public class CrosshairManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            Debug.LogWarning("CrosshairManager: WeaponController not found!");
        }
    ...
    void UpdateBloomScaling()
    {
        ...
        if (weaponController != null && weaponController.CurrentWeapon != null)
        {
            var weapon = weaponController.CurrentWeapon as WeaponInstance_Hitscan;
            if (weapon != null)
            {
                bloomPercentage = weapon.GetBloomPercentage();
            }
        }

...
public class UIAmmoWidget : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (_weaponController == null) { enabled = false; return; }
        ...
        HandleWeaponChanged(_weaponController.CurrentWeaponDisplayName, _weaponController.CurrentTierName);
        HandleAmmoChanged(_weaponController.CurrentAmmoInMag, _weaponController.CurrentReserveAmmo);
    }
